...
let effects = {
    ...
    "supply": {
        ...
        "DD":{"precap":[1.3], "postcap":[1.6]},
        "E":{"precap":[1.5], "postcap":[1.3]},
        "FF":{"precap":[1.3], "postcap":[1.6]},
        ...
        return {
            ...
            enemyList: [
                ...
                },
                {
                    "text":"対空小鬼",
                    "stat":[
                        {"text":"一般", "hp":88, "armor":60},
                        {"text":"elite", "hp":188, "armor":95}
                    ],
                    "effect": effects['artillery']
                },
                {
                ...
                },
                {
                    ...
                    "stat":[
                        ...
                        {"text":"II", "hp":1600, "armor":177},
                        {"text":"壊I", "hp":1000, "armor":121},
                        {"text":"壊II", "hp":1600, "armor":211},
                    ],
                    "effect": effects['artillery']
                }
            ]

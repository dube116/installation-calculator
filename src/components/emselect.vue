...
let effects = {
    "artillery": {
        ...
        166:{"precap":[1.5, 1, 1, 1, 1, 1]},
        "166_2":{"precap":[1, 1.4, 1, 1, 1, 1]},
    ...
    "harbourSummer": {
        ...
        166:{"precap":[1.6, 1, 1, 1, 1, 1]},
        "166_2":{"precap":[1, 1.5, 1, 1, 1, 1]},
    ...
    "supply": {
        ...
        166:{"precap":[1.5, 1, 1, 1, 1, 1], "postcap":[1.3, 1, 1, 1, 1, 1]},
        "166_2":{"precap":[1, 1.3, 1, 1, 1, 1], "postcap":[1, 1.6, 1, 1, 1, 1]},
    ...
    "supply3V": {
        ...
        166:{"postcap":[1.3, 1, 1, 1, 1, 1]},
        "166_2":{"postcap":[1, 1.6, 1, 1, 1, 1]},
    ...
    "anchorWDV": {
        ...
        166:{"postcap":[1.2, 1, 1, 1, 1, 1]},
        "166_2":{"postcap":[1, 1.4, 1, 1, 1, 1]},
    ...
    "dock": {
        ...
        166:{"postcap":[1.15, 1, 1, 1, 1, 1]},
        "166_2":{"postcap":[1, 1.15, 1, 1, 1, 1]},
            ...
            enemyList: [
                ...
                },
                {
                    ...
                    "stat":[
                        ...
                        {"text":"III", "hp":4800, "armor":125},
                        {"text":"IV", "hp":8000, "armor":185},
                        {"text":"壞I", "hp":1200, "armor":26},
                        {"text":"壞II", "hp":2400, "armor":115},
                        {"text":"壞III", "hp":4800, "armor":134},
                        {"text":"壞IV", "hp":8000, "armor":225}
                    ],
                    "effect": effects['supply']
                },
                {

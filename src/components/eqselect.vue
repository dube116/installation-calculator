	...
	data () {
		return {
			eqlist: [
                ...
                {"text":"大發動艇(R35＆フランス兵)","value":576,"imp":true,"title":""},
                ...
                {"text":"特大發＋チハ改","value":495,"imp":true,"title":""},
                {"text":"M4A1 DD","value":355,"imp":true,"title":""},
                {"text":"裝甲艇(AB艇)","value":408,"imp":true,"title":""},
                {"text":"武裝大發","value":409,"imp":true,"title":""},
                {"text":"特二式內火艇","value":167,"imp":true,"title":""},
                {"text":"特四式內火艇","value":525,"imp":true,"title":""},
                {"text":"特四式內火艇改","value":526,"imp":true,"title":""},
                ...
                {"text":"陸軍歩兵部隊 ※陸軍","value":496,"imp":false,"title":""},
                {"text":"九七式中戦車(チハ) ※陸軍","value":497,"imp":true,"title":""},
                {"text":"九七式中戦車 新砲塔(チハ改) ※陸軍","value":498,"imp":true,"title":""},
                {"text":"陸軍歩兵部隊＋チハ改 ※陸軍","value":499,"imp":false,"title":""},
			...
			eq_id: [9999,68,166,436,576,193,230,449,482,514,494,495,355,408,409,167,525,526,35,36,126,348,349,346,347,496,497,498,499,10001,267,366,10002,10003,10,12,10004,10005,41,10006,10007,10008,10009,490,10010,10011,10012,10013,10014,10015,129],
            equipment: {
                id: 0, 
                imp: 0
            }
